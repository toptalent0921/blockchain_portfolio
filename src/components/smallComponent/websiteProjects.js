                        ...
                        <div className=" bg-gray-950 rounded-md">
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex justify-between mt-4 space-x-3 md:mt-6">
                                    <a
                                        href="https://github.com/toptalent0921/test-assignment"
                                        target="_blank"
                                        rel="noreferrer"
                        ...
                        <div className=" bg-gray-950 rounded-md">
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex justify-center mt-4 space-x-3 md:mt-6">
                                    <a
                                        href="https://github.com/toptalent0921/job-portal"
                                        target="_blank"
                                        rel="noreferrer"
                    ...
                    <div className=" relative  max-w-sm p-1   rounded-lg shadow   ">
                        <div className=" bg-gray-950 rounded-md">
                            ...
                            <div className="p-5">
                                ...
                                <div className="flex justify-center mt-4 space-x-3 md:mt-6">
                                    <a
                                        href="https://github.com/toptalent0921/blockchain_portfolio"
                                        target="_blank"
                                        rel="noreferrer"
